...
const checks=[
 ...
 ['lib/website-pages-cms.ts',['WebsiteCmsPageKey','WEBSITE_CMS_PAGES','organisations','community','projects','opportunities','showcase','events','people','spotlight','blog','careers','faq','partnership','feedback','community_guidelines','privacy','terms','Legal','legalFields','defaultWebsiteCmsPagePayload','validateWebsiteCmsPagePayload','getPublicWebsiteCmsPage','managerHref']],
 ['app/privacy/page.tsx',["getPublicWebsiteCmsPage('privacy')",'legal_title','last_updated','legalSection']],
 ['app/terms/page.tsx',["getPublicWebsiteCmsPage('terms')",'legal_title','last_updated','legalSection']],
 ...
 ['supabase/migrations/20260821223500_expand_website_page_registry.sql',['website_page_public','website_page_drafts','website_page_revisions','community_guidelines','opportunities','careers','privacy','terms']],

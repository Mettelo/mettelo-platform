...
const PAGE_RULES:readonly RouteRule[]=[
 ...
 {prefix:'/admin/project-support',capabilities:['projects.support.manage']},
...
const API_RULES:readonly RouteRule[]=[
 ...
 {prefix:'/api/admin/project-support-recovery',capabilities:['projects.support.manage','projects.manage']},
 {prefix:'/api/admin/project-support-cases',capabilities:['projects.support.manage']},

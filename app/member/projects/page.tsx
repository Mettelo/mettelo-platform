...
export default async function MyProjectsPage({searchParams}:{searchParams:Promise<Search>}){
  ...
  return <main className={styles.page} aria-labelledby="projects-title">
    <div className={styles.crumb}><Link href="/member">My Mettelo</Link> / <strong>Projects</strong></div>
    <header className={styles.hero}>
      ...
      <div className={styles.heroActions}><Link className={`${styles.button} ${styles.buttonDark}`} href="/projects">Discover projects</Link><Link className={styles.button} href="/member/recommended">Recommended</Link></div>
    </header>
    ...
    <section className={styles.explore} aria-labelledby="explore-title"><div><div className={styles.eyebrow}>EXPLORE & GROW</div><h2 id="explore-title">Ready for another project?</h2><p>Discover broad project opportunities or start with projects matched to your profile. These remain secondary while current work needs attention.</p></div><div className={styles.heroActions}><Link className={`${styles.button} ${styles.buttonDark}`} href="/projects">Discover projects</Link><Link className={styles.button} href="/member/recommended">See recommendations</Link></div></section>
  </main>;
}

...
export default function SignInPage(){
  ...
  async function submit(event:FormEvent<HTMLFormElement>){
    ...
    try{
      if(!configured) throw new Error('Account access is not live yet because Supabase has not been connected to this deployment.');
      ...
      if(mode==='signup'){
        ...
        setStatus('success');setMessage('Account created. Check your email if confirmation is required, then sign in.');
      }else if(mode==='reset'){

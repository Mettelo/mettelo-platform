...
export default function MemberCollaboratorDiscovery(props:Props){
 ...
 return <div className="mcdRoot">
  ...
  <section className="mcdSearch" aria-labelledby="search-network-title">
   <div className="mcdSectionHead"><div><span>SEARCH THE NETWORK</span><h2 id="search-network-title">Search the network</h2><p>Search discoverable members. Private profile information is never included. Inviting someone does not add them to your team; a request stays pending until they accept and the governed joining checks continue.</p></div><Link href="/member/blocked-members">Manage blocked members</Link></div>

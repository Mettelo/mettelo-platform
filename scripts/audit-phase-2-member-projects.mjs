...
const checks=[
  ...
  ['components/MemberProfileSection.tsx',['Profile completion','Matching','Application','Public profile','PROJECT AVAILABILITY','Preview public profile','calculateMemberReadiness']],

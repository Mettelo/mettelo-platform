...
const checks=[
  ...
  ['components/AdminProjectCreateButton.tsx',['Create project','Choose project type','Team size required','Partner name','Create private draft']],
  ...
  ['app/admin/project-operations/projects/[id]/page.tsx',['Admin / Projects / Projects /','Project brief','BRIEF DETAILS','COHORTS','APPLICATION DEADLINE','PROJECT METADATA','Applications received','Open Team Formation','AdminProjectVisibilityControl','AdminExpandableText']],

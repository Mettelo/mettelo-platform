-- Repair the production-recovery constraint to match the later Phase 9 runtime
-- contract. Flexible projects may define a collaborative minimum greater than
-- one; a Solo/Flexible run can still resolve its runtime minimum to one.

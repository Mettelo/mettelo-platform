...
export default async function AdminWebsiteOverviewPage(){
 ...
 return <AdminWorkspaceOverview
  ...
  description="Manage Mettelo's public pages, navigation, footer, social/contact details, branding, media and search presentation from one governed Admin workspace. Draftable controls stay separate from published public configuration until an authorized Admin publishes them."
  available={[
   ...
   {title:'Media',description:'Upload governed public images, maintain accessibility metadata, copy stable URLs and archive assets without breaking published references.',href:'/admin/website/media',label:'Upload & manage'},

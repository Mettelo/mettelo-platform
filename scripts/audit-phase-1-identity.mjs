...
const checks=[
 ...
 ['onboarding has explicit completion state with preserved destination',Boolean(onboardingComplete)&&onboarding.includes('window.location.assign(`/onboarding/complete?next=${encodeURIComponent(returnTo)}`)')&&onboardingComplete.includes('Your professional profile is ready to use.')&&onboardingComplete.includes('href={next}')],

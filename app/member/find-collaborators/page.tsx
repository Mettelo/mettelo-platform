...
export default async function LegacyFindCollaboratorsPage({searchParams}:{searchParams?:Promise<Search>}){
  ...
  // Preserve legacy deep links only long enough for the canonical page to validate them server-side.

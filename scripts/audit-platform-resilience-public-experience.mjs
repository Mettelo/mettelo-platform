...
expect('app/page.tsx',['Professional capability infrastructure','technology-led platform','href="/auth/signup"','Africa and beyond','href="/faq"','HomeHeroShowcase','getHeroMetrics',"db.from('profiles')"],'homepage positioning live metrics and direct signup');
expect('components/HomeHeroShowcase.tsx',['role="tablist"','aria-selected','Previous showcase slide','Next showcase slide','LIVE_THRESHOLD=500','Community reach','Mettelo members','Projects delivered','Public projects','Proof signals','Verified Proof','Established Mettelo total','Live platform total'],'accessible three-slide homepage showcase and threshold social proof');

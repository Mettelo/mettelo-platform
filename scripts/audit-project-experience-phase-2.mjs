...
const checks=[
 ...
 ['preferred roles use and validate canonical project role catalogue',Boolean(roleCatalogue)&&profileApi.includes("from('project_role_catalogue')")&&onboarding.includes("fetch('/api/project-role-catalogue')")&&profile.includes("fetch('/api/project-role-catalogue')")],

...
const canonicalPublicDetail="['app/projects/[id]/page.tsx',['ProjectPublicDetailV2','getProjectExperiencePlanning','buildProjectExperienceModel','roles.length>0']],\n  ['components/project-experience/ProjectPublicDetailV2.tsx',['Decide whether this is the right project for you.','Applications close','Continue to apply','Open in My Mettelo','01 · Understand the challenge','02 · Data & trust','03 · What you will produce','04 · Quality bar','05 · Capability & evidence','06 · Contribution areas','07 · Delivery journey','Know the expectation before you commit.','These are evidence opportunities, not automatic Proof awards.']],";

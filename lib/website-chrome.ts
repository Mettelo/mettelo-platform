...
export type WebsiteNavigationPlacement='primary'|'secondary'|'explore';
export type WebsiteNavigationItem={id:string;label:string;href:string;placement:WebsiteNavigationPlacement;desktop_visible:boolean;mobile_visible:boolean;enabled:boolean;sort_order:number};
export type WebsiteNavigationConfig={items:WebsiteNavigationItem[]};
export type WebsiteFooterLink={id:string;label:string;href:string;enabled:boolean;sort_order:number};
export type WebsiteFooterSection={id:string;title:string;enabled:boolean;sort_order:number;links:WebsiteFooterLink[]};
export type WebsiteFooterConfig={description:string;tagline:string;sections:WebsiteFooterSection[]};
export type WebsiteBrandingConfig={site_name:string;logo_dark_url:string;logo_light_url:string};
export type WebsiteChromeConfig={navigation:WebsiteNavigationConfig;footer:WebsiteFooterConfig;branding:WebsiteBrandingConfig};

const DEFAULT_NAVIGATION:WebsiteNavigationConfig={items:[
 {id:'projects',label:'Projects',href:'/projects',placement:'primary',desktop_visible:true,mobile_visible:true,enabled:true,sort_order:10},
 {id:'opportunities',label:'Opportunities',href:'/opportunities',placement:'primary',desktop_visible:true,mobile_visible:true,enabled:true,sort_order:20},
 {id:'proof',label:'Proof',href:'/showcase',placement:'primary',desktop_visible:true,mobile_visible:true,enabled:true,sort_order:30},
 {id:'events',label:'Events',href:'/events',placement:'primary',desktop_visible:true,mobile_visible:true,enabled:true,sort_order:40},
 {id:'organisations',label:'For organisations',href:'/organisations',placement:'secondary',desktop_visible:true,mobile_visible:true,enabled:true,sort_order:50},
 {id:'about',label:'About Mettelo',href:'/about',placement:'secondary',desktop_visible:true,mobile_visible:true,enabled:true,sort_order:60},
 {id:'community',label:'Community',href:'/community',placement:'explore',desktop_visible:true,mobile_visible:true,enabled:true,sort_order:70},
 {id:'insights',label:'Insights',href:'/blog',placement:'explore',desktop_visible:true,mobile_visible:true,enabled:true,sort_order:80},
 {id:'spotlight',label:'Spotlight',href:'/spotlight',placement:'explore',desktop_visible:true,mobile_visible:true,enabled:true,sort_order:90},
 {id:'careers',label:'Careers',href:'/careers',placement:'explore',desktop_visible:true,mobile_visible:true,enabled:true,sort_order:100},
 {id:'faq',label:'FAQ',href:'/faq',placement:'explore',desktop_visible:true,mobile_visible:true,enabled:true,sort_order:110},
 {id:'contact',label:'Contact',href:'/contact',placement:'explore',desktop_visible:false,mobile_visible:true,enabled:true,sort_order:120},

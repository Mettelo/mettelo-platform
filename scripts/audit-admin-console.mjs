...
const checks=[
  ...
  ['app/admin/project-operations/applications/page.tsx',['Admin / Recruiting / Project Applications','focusProjectId','query.eq(\'project_id\',focusProjectId)','AdminApplicationQueue','project_roles:project_roles!project_applications_project_role_id_fkey(title)','items=mapped.map(item=>item.queue)','All project interest and application submissions are visible here for Admin oversight.','AUTO start oversight','autoByRun']],
  ...
  ['components/AdminTeamFormation.tsx',['Search project or member','Current teams','All statuses','Projects per page','Previous','Next','Start normally','Force start','Admin intervention reason','Force start may override ordinary Team formation and AUTO timing blockers. The server still revalidates hard Lab/system readiness, lifecycle and capacity.','Delivery responsibilities','Add responsibility','Assign','Make Project Lead','Minimum','Target','Maximum','Open places','runCard','memberCard']],

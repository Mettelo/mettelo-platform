...
expect('components/HeaderNavigation.tsx',["['Projects','/projects']","['Opportunities','/opportunities']","['Proof','/showcase']","['Events','/events']","['Insights','/blog']","['For organisations','/organisations']",'exploreNavigation',"['Community','/community']","['Spotlight','/spotlight']","['Careers','/careers']","['About','/about']","['FAQ','/faq']",'exploreMenu','explorePanel','Mobile Explore navigation'],'global Explore navigation architecture');
...
expect('app/home-social-proof.css',['heroCommunityProof','heroCommunityAvatar','@media(max-width:480px)','@media(min-width:481px) and (max-width:1024px)','@media(min-width:1025px)','overflow-wrap:anywhere'],'community social proof is responsive and contained');

...
export default function MemberProjectDetailV2({model,state,stateLabel,stateCopy,primaryAction,applicationReady,profileCompletion,applicationMissing,roleAvailabilityKnown,saved,roles,contributionAreas,fit}:Props){
 ...
 return <div className={styles.page}>
  ...
  <MemberProjectDetailBodyV3 model={model} roles={roles} contributionAreas={contributionAreas} projectId={project.id} canApply={state==='open_eligible'} applicationReady={applicationReady} applicationMissing={applicationMissing} fit={fit}/>
 </div>
}

...
const HOME_FIELDS:WebsitePageFieldDefinition[]=[
 {key:'hero_eyebrow',label:'Eyebrow',group:'Hero',kind:'text',maxLength:100,fallback:'REAL WORK · VISIBLE CONTRIBUTION · METTELO PROOF'},
 {key:'hero_title',label:'Headline',group:'Hero',kind:'text',maxLength:180,fallback:'Build experience through'},
 {key:'hero_accent',label:'Headline accent',group:'Hero',kind:'text',maxLength:100,fallback:'real work.'},
 {key:'hero_lead',label:'Lead paragraph',group:'Hero',kind:'textarea',maxLength:500,fallback:'Mettelo helps Information Technology, Data & AI professionals contribute to real project work and make what they do easier to understand.'},
 {key:'hero_support',label:'Support paragraph',group:'Hero',kind:'textarea',maxLength:600,fallback:'Record contribution and supporting evidence, complete review and build credible Mettelo Proof that adds context to your professional profile.'},

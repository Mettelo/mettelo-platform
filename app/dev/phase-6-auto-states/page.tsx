...
export default function Phase6AutoStatesPreview(){
 ...
 const items=[
  ...
  {id:'auto-ready',status:'approved',admission_decision:'auto_qualified',participation_preference:'flexible',projects:{title:'Flexible project ready for daily start',status:'open'},formation:{filled:2,threshold:2,status:'forming',scheduled_start_at:new Date(now-60*60*1000).toISOString(),run_number:2}},

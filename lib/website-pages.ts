...
const HOME_FIELDS:WebsitePageFieldDefinition[]=[
 {key:'hero_eyebrow',label:'Eyebrow',group:'Hero',kind:'text',maxLength:100,fallback:'BUILD · PROVE · GET DISCOVERED'},
 {key:'hero_title',label:'Headline',group:'Hero',kind:'text',maxLength:180,fallback:'Build Data & AI skills through'},
 {key:'hero_accent',label:'Headline accent',group:'Hero',kind:'text',maxLength:100,fallback:'real work.'},
 {key:'hero_lead',label:'Lead paragraph',group:'Hero',kind:'textarea',maxLength:500,fallback:'Join practical projects, contribute to real outcomes, and build verified Proof of what you can do.'},
 {key:'hero_support',label:'Support paragraph',group:'Hero',kind:'textarea',maxLength:600,fallback:'Use that evidence to strengthen your profile, demonstrate your capability, and become easier to discover for opportunities.'},
 ...
 {key:'how_title',label:'Heading',group:'How Mettelo works',kind:'text',maxLength:180,fallback:'From interest to evidence.'},
 {key:'how_body',label:'Intro copy',group:'How Mettelo works',kind:'textarea',maxLength:600,fallback:'You do not need another place to simply list skills. Mettelo helps you develop them through work that produces visible evidence.'},
 {key:'proof_eyebrow',label:'Eyebrow',group:'Proof',kind:'text',maxLength:100,fallback:'METTELO PROOF'},
 {key:'proof_title',label:'Heading',group:'Proof',kind:'text',maxLength:180,fallback:'Show the work behind the skill.'},
 {key:'proof_lead',label:'Lead copy',group:'Proof',kind:'textarea',maxLength:700,fallback:'A CV can tell people what you know. Mettelo Proof helps show what you worked on, what you contributed, and what evidence supports it.'},
 {key:'proof_note',label:'Verification note',group:'Proof',kind:'textarea',maxLength:700,fallback:'Verification confirms the recorded contribution has been reviewed. It is not a claim of employment, certification or endorsement beyond the evidence shown.'},
 {key:'proof_cta_label',label:'CTA label',group:'Proof',kind:'text',maxLength:80,fallback:'Explore verified Proof →'},
 ...
 {key:'organisations_title',label:'Heading',group:'Organisations',kind:'text',maxLength:180,fallback:'Bring a Data & AI problem worth solving.'},
 {key:'organisations_lead',label:'Lead copy',group:'Organisations',kind:'textarea',maxLength:700,fallback:'Mettelo gives organisations a structured way to engage professionals around practical challenges, talent and collaboration.'},
 ...
 {key:'why_title',label:'Heading',group:'Why Mettelo',kind:'text',maxLength:180,fallback:'Real work creates stronger signals.'},
 {key:'why_lead',label:'Lead copy',group:'Why Mettelo',kind:'textarea',maxLength:500,fallback:'Capability becomes more useful when there is evidence behind it.'},
 {key:'why_body',label:'Main copy',group:'Why Mettelo',kind:'textarea',maxLength:1000,fallback:'Mettelo is a technology-led platform focused on helping Data & AI professionals build practical capability through real work, prove contribution with evidence and connect that evidence to opportunity.'},
 {key:'why_scope',label:'Geographic / ambition copy',group:'Why Mettelo',kind:'textarea',maxLength:900,fallback:'We are building this professional infrastructure with a focus on Africa and beyond — creating signals that can travel across teams, organisations and borders.'},
 {key:'final_eyebrow',label:'Eyebrow',group:'Final CTA',kind:'text',maxLength:100,fallback:'YOUR NEXT STEP'},
 {key:'final_title',label:'Heading',group:'Final CTA',kind:'text',maxLength:180,fallback:'Build the evidence behind your skills.'},
 {key:'final_body',label:'Body copy',group:'Final CTA',kind:'textarea',maxLength:700,fallback:'Join Mettelo, find a Data & AI project and start turning real contribution into stronger professional Proof.'},
...
const ABOUT_FIELDS:WebsitePageFieldDefinition[]=[
 ...
 {key:'hero_lead',label:'Lead paragraph',group:'Hero',kind:'textarea',maxLength:1200,fallback:'Mettelo is a technology-led organisation building professional capability infrastructure for Data & AI. We are creating a connected system where people build through real work, turn contribution into credible Proof, grow with others and become discoverable for what they have actually done.'},
 ...
 {key:'thesis_title',label:'Thesis heading',group:'Hero',kind:'text',maxLength:180,fallback:'Capability is becoming professional currency.'},
 {key:'thesis_body',label:'Thesis copy',group:'Hero',kind:'textarea',maxLength:700,fallback:'The future of work will reward more than what people know. It will reward what they can apply, build, communicate and create with others — and the evidence that proves it.'},
 ...
 {key:'gap_body',label:'Intro copy',group:'Capability gap',kind:'textarea',maxLength:800,fallback:'Mettelo is being built to break that loop by connecting meaningful work, contribution, Proof, relationships and opportunity into one continuous system.'},
 ...
 {key:'ecosystem_body',label:'Intro copy',group:'Ecosystem',kind:'textarea',maxLength:800,fallback:'Mettelo Community is the front door — not the whole company. The wider technology organisation connects how people build, prove, discover and deploy capability.'},
 {key:'future_eyebrow',label:'Eyebrow',group:'Future',kind:'text',maxLength:100,fallback:'Where we are going'},
 {key:'future_title',label:'Heading',group:'Future',kind:'text',maxLength:240,fallback:'Africa and beyond: Data & AI is our starting point, not the boundary of the ambition.'},
 {key:'future_body',label:'Intro copy',group:'Future',kind:'textarea',maxLength:800,fallback:'We are starting where transformation is fastest and practical Proof matters most, then extending the model as the infrastructure matures.'},
 {key:'mission_title',label:'Mission heading',group:'Mission & vision',kind:'text',maxLength:220,fallback:'Build the infrastructure that enables people to develop, demonstrate and deploy real capability.'},
 {key:'mission_body',label:'Mission copy',group:'Mission & vision',kind:'textarea',maxLength:700,fallback:'We do that through meaningful work, open collaboration, intelligent technology and credible evidence.'},
 ...
 {key:'vision_body',label:'Vision copy',group:'Mission & vision',kind:'textarea',maxLength:1200,fallback:'We believe professionals across Africa should be able to access serious delivery environments, create credible evidence of what they can do and carry that evidence across borders. Mettelo is building infrastructure with African ambition and global usefulness: technology that helps capability become visible, trusted and easier to connect to opportunity wherever professionals and organisations are based.'},
 ...
 {key:'founder_quote',label:'Founder quote',group:'Founder',kind:'textarea',maxLength:1000,fallback:'People should not have to wait for the perfect title or the perfect opportunity before they can prove they create value. We can build better infrastructure for capability to become visible, trusted and useful.'},

...
const checks=[
 ...
 ['tests/admin-website-pages.spec.ts',['dangerous.values.hero_primary_href','website.page.published','originalDraft','originalPublished','Publish page','input[name="name"]','#contact-email','select[name="topic"]','textarea[name="message"]','input[name="consent"]','390,768,1440']]
];

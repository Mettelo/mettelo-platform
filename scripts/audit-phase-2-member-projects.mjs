...
const checks=[
  ...
  ['components/ProjectApplicationForm.tsx',['localStorage','Draft saved automatically','Complete these','REVIEW APPLICATION','Confirm & submit','Project Participation Terms','terms_attachment_id','terms_accepted']],
  ...
  ['app/api/project-applications/route.ts',['application_deadline','applications_open','team_place_released','waiting_for_team','terms_attachment_id','terms_accepted_at','Project Participation Terms']],

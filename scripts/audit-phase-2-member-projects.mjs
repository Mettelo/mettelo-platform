...
const checks=[
  ...
  ['app/member/page.tsx',['Good to see you','Up next · Project work','IMPORTANT UPDATES','Continue working','Latest status','PROFILE COMPLETION','Evidence that travels with you','Open Mettelo Lab','role="progressbar"','mobileMoreNav','aria-label="Member overview"','calculateMemberReadiness']],
  ['app/member/member-home-v3.module.css',['width:min(100%,1240px)','grid-template-columns:repeat(4,minmax(0,1fr))','grid-template-columns:minmax(0,1.65fr) minmax(320px,.85fr)','@media(max-width:1100px)','@media(max-width:768px)','@media(max-width:480px)','prefers-reduced-motion:reduce']],
  ['app/member/profile/page.tsx',['ProfileReturnAfterSave','MemberProfileSection','Better project matches','Faster applications']],
  ['components/MemberProfileSection.tsx',['Profile completion','MATCHING','APPLICATIONS','PUBLIC PROFILE','PROJECT AVAILABILITY','Preview public profile','calculateMemberReadiness']],
  ...
  ['app/member/discover/[id]/apply/page.tsx',['calculateMemberReadiness','applicationReadiness.ready','resolveMemberProjectState',"state!=='open_eligible'",'MemberProjectApplicationFlow']],

...
import type {ProjectTeamOverview} from '@/lib/project-team-overview';
...
export default function MetteloLabPanel(props:Props){
 ...
 return <section className="metteloLab" id="mettelo-lab" aria-labelledby="mettelo-lab-title">
  ...
  <ProjectTeamRoster projectId={props.projectId} projectRunId={props.projectRunId} currentUserId={props.currentUserId} canManageSubmissionPermissions={props.canManageSubmissionPermissions} initialOverview={props.teamOverview}/>

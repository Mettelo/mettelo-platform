...
const checks=[
  ...
  ['app/admin/project-operations/applications/page.tsx',['Admin / Recruiting / Project Applications','focusProjectId','query.eq(\'project_id\',focusProjectId)','AdminApplicationQueue',"decision!=='auto_qualified'",'Human review and AUTO oversight are intentionally separate.','AUTO start oversight','autoByRun']],

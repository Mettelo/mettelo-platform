...
function ProofHero(){return <MemberPageHeader eyebrow="MY WORK · VERIFIED EVIDENCE" title="Proof" description="Your verified record of what you contributed through real Mettelo project work — the evidence behind your skills, roles and professional story." actions={<><a className="proofButton proofButtonDark" href="/member/profile">View profile</a><a className="proofButton" href="/member/discover">Find another project</a></>}/>}

function ProofError(){return <div className="proofPage"><ProofHero/><section className="proofLoadError" role="alert"><div><h2>We couldn&apos;t load your Proof</h2><p>Your evidence has not been changed or lost. Retry the portfolio, or continue to Projects while this view recovers.</p></div><div className="proofLoadActions"><a href="/member/proof" className="proofButton proofButtonDark">Try again</a><a href="/member/projects" className="proofButton">Open Projects</a></div></section><style>{pageStyles}</style></div>}

...
const tools:Item[]=[
 {view:'resources',label:'Resources',icon:'⌑',description:'Files and project references'},
 {view:'events',label:'Events',icon:'◷',description:'Sessions and presentation'},
 {view:'team',label:'Team',icon:'◎',description:'Your team and working state'},
];
const more:Item[]=[
 {view:'plan',label:'Plan',icon:'◇',description:'Problem, outcomes and milestones'},
 {view:'proof',label:'Proof',icon:'✓',description:'Evidence and completion'},
 ...tools,
];
const mobile:Item[]=[
 {view:'home',label:'Home',icon:'⌂'},
...
export default function MetteloLabNavigation({placement,unreadCount=0}:{placement:Placement;unreadCount?:number}){

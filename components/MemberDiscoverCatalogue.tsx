...
export default function MemberDiscoverCatalogue({projects}:Props){
  ...
  return <>
    ...
    <div className="mdCatalogueHead"><strong>{visible.length} {visible.length===1?'project':'projects'} shown</strong><span>Discover stays broad. Recommended is personalised.</span></div>

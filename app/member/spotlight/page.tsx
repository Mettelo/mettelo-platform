...
export default async function MemberSpotlightPage(){
  ...
  return <section className="memberSpotlightPage" aria-labelledby="member-spotlight-title">
    ...
    <style>{`
      ...
      @media(max-width:480px){.memberSpotlightHero{padding-top:18px}.memberSpotlightHeroActions{display:none}.memberSpotlightPage{gap:18px}.memberSpotlightPrinciple{padding:18px}}
    `}</style>
  </section>;
}

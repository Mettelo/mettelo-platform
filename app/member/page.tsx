...
export default async function MemberDashboard(){
  ...
  return <section className={`${styles.memberScope} section softSection memberWorkspace`}><div className="shell memberDashboardMain">
    <header className="memberHero"><div className="eyebrow">Dashboard</div><h1>Welcome, {name}.</h1><p className="lead">Focus on what needs action now. Detailed project requests, projects, Proof and profile management each have their own workspace.</p></header>

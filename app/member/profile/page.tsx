...
export default async function ProfilePage(){
  ...
  return <section className="section softSection memberWorkspace"><div className="shell"><div className="sectionHead"><div><div className="eyebrow">Identity · Profile</div><h1>Your professional identity on Mettelo.</h1></div><p>Your profile drives project matching, application readiness, collaboration context, People visibility and the evidence behind verified Proof.</p></div><MemberProfileSection userId={user.id} profile={profile} domains={domains} tools={tools} domainPreferences={domainPreferences} toolPreferences={toolPreferences}/></div></section>;
}

...
const checks=[
  ...
  ['app/admin/project-operations/applications/page.tsx',['Admin / Projects / Requests','focusProjectId','query.eq(\'project_id\',focusProjectId)','AdminApplicationQueue','AUTO admissions',"decision!=='auto_qualified'",'genuinely require human review']],
  ['components/AdminApplicationQueue.tsx',['Current requests','All statuses','Filter project requests by status','Rows per page','Previous','Next','No project requests match your filters','applicationTable','applicationMobileList','Project interest','Project application']],

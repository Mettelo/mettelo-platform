-- Phase 22 release hardening: keep native device-share analytics aligned across client, API, and database.
-- Phase 18C originally introduced the analytics contract before the native share surface was added.
...
begin
  ...
  where id=p_collaboration_need_id;

...
expect('components/HeaderNavigation.tsx',["['Projects','/projects']","['Opportunities','/opportunities']","['Proof','/showcase']","['Events','/events']","['For organisations','/organisations']","['About Mettelo','/about']",'exploreNavigation',"['Community','/community']","['Insights','/blog']","['Spotlight','/spotlight']","['Careers','/careers']","['FAQ','/faq']",'exploreMenu','explorePanel','Mobile Explore navigation'],'global Explore navigation architecture');

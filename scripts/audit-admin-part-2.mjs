...
const checks=[
 ...
 ['app/admin/careers/pipeline/page.tsx',['Pipeline overview','AdminCareerPipelineBoard']],
 ['components/AdminCareerPipelineBoard.tsx',['careerKanban','submitted','shortlisted','interview','offer','hired','rejected','@media(max-width:760px)']],
 ['app/admin/intake/page.tsx',['AdminIntakeQueue',"import './intake.css'",'intakeWorkspace']],
 ['app/admin/intake/intake.css',['.intakeWorkspace .adminTableShell','.intakeWorkspace .adminToolbar','.intakeWorkspace .adminPagination','.intakeWorkspace .intakeDetail','min-height:44px','@media(max-width:760px)','@media(max-width:480px)','font-size:16px']],
 ...
 ['app/admin/notifications/overview/page.tsx',['AdminCommunicationOverviewPanel','communication_templates','email_outbox']],
 ['components/AdminCommunicationOverviewPanel.tsx',['NEEDS ATTENTION','Delivery health','Templates','Delivery Queue','Event Catalogue','@media(max-width:760px)']],

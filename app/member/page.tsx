...
export default async function MemberDashboard(){
  ...
  return <section className="section softSection memberWorkspace"><div className="shell dashboard memberDashboard">
    ...
    <div className="dashboardMain memberDashboardMain" id="overview">
      <header className="memberHero"><div className="eyebrow">Member workspace</div><h1>Welcome, {name}. What are you moving forward?</h1><p className="lead">Your profile, Labs applications, active projects and verified contribution stay connected to one Mettelo identity.</p></header>
      ...
      <section className="panel memberSection" id="proof"><div className="panelHead"><h3>Your contribution record</h3><a className="linkArrow" href="/showcase">Explore public Proof →</a></div>{contributions.length?<div className="grid3">{contributions.slice(0,6).map(item=>{
        ...
        const shareUrl='https://mettelo.com/showcase';

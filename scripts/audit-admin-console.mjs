...
const checks=[
  ...
  ['components/AdminTeamFormation.tsx',['Search project or member','Current teams','All statuses','Projects per page','Previous','Next','Start normally','Force start','Admin intervention reason','Force start overrides ordinary Team formation blockers only after hard Lab/system readiness passes.','Delivery responsibilities','Add responsibility','Assign','Make Project Lead','Minimum','Target','Maximum','Open places','runCard','memberCard']],

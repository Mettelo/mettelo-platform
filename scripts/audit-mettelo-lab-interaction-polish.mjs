...
const checks=[
 ...
 ['device QA checks drop-up, composer visibility and mobile action sheet',qa.includes('Mettelo Lab More is an anchored drop-up')&&qa.includes('toBeInViewport()')&&qa.includes('Message action sheet spans the mobile interaction width')],

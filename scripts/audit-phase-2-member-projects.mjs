...
const checks=[
  ...
  ['app/api/project-completion/route.ts',['changes_requested','reviewed_by_user_id','assigned Project Architect','Project completion approved']],
  ...
  ['components/ProjectTeamRoster.tsx',['COHORTS','Final Proof delegate','profile photo','cohortSwitcher']],
  ['components/AdminCompletionRequirements.tsx',['Presentation','GitHub repository','Final Proof']],

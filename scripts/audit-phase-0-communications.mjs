...
const checks=[
 ...
 ['admin communication centre UI',adminUi.includes('TEMPLATE EDITOR')&&adminUi.includes('communicationMasterDetail')&&adminUi.includes('Publish changes')],
 ['template preview and test-send UI',adminUi.includes('LIVE PREVIEW')&&adminUi.includes('Send test')],

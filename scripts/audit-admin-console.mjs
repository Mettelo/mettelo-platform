...
const checks=[
  ...
  ['components/AdminProjectManager.tsx',['Search by project name or partner','Team fill % ascending','Rows per page','Archive selected','Change visibility','No projects match these filters','rowMenu','mobileProjectList']],
  ['app/admin/project-operations/projects/[id]/page.tsx',['Admin / Projects / Projects /','Project brief','BRIEF DETAILS','TEAM FILL','APPLICATION DEADLINE','PROJECT METADATA','Applications received','Open Team Formation']],
  ...
  ['app/admin/project-operations/applications/page.tsx',['Admin / Projects / Applications','open','AdminApplicationQueue']],
  ['components/AdminApplicationQueue.tsx',['Project','Applied from','Applied to','Approve selected → team','MESSAGE PREVIEW','Confirm status & send','No applications match your filters','applicationTable','applicationMobileList']],

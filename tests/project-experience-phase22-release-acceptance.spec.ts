...
test.describe('Phase 22 collaboration release acceptance',()=>{
 ...
 test('all three collaboration routes converge on the canonical need and same-run systems',()=>{
  ...
  const network=read('app/member/collaboration/page.tsx');

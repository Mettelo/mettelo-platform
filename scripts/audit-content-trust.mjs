...
requireText('Contribution submission semantics',contributionForm,['YOUR CONTRIBUTION','Record what you contributed','Submit for review →','Spotlight publication remains a separate consent process.']);
forbidText('Contribution submission semantics',contributionForm,['Mettelo Proof/Showcase','Submit for verification →']);

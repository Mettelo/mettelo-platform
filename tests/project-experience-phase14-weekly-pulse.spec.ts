...
const cases:[string,boolean][]=[
 ...
 ['Member/project/run integrity is database-enforced',migration.includes('Project pulse member, project and run do not match')&&migration.includes('before insert or update of project_member_id, project_id, project_run_id, user_id')],
 ...
 ['Solo and Flexible-Solo omit team state through Phase 9 authority',hardening.includes("participation = 'solo'")&&hardening.includes("participation = 'flexible'")&&hardening.includes('member_count > 1')&&hardening.includes('new.team_state := null')&&ui.includes('Independent project check-in')],

...
function AwardCard({item}:{item:PublicSpotlightAward}){
  ...
  return <article className="spotlightPublicCard">
    <div className="spotlightPublicCardTop">
      <span className="chip green">{categoryLabel(item.category)} · {monthLabel(item.awardMonth)}</span>
...
export default async function SpotlightPage(){
  ...
  return <>
    ...
    <style>{`
      .spotlightPublicHero{padding:58px 0 42px;background:linear-gradient(180deg,#fbf7ee 0%,#fcfbf7 100%);border-bottom:1px solid #e7e1d6}.spotlightPublicHeroGrid{display:grid;grid-template-columns:minmax(0,1.15fr) minmax(300px,.85fr);gap:44px;align-items:start}.spotlightPublicHero h1{max-width:850px;margin:10px 0 18px;font-size:clamp(2.7rem,5vw,5rem);line-height:.98;letter-spacing:-.045em;overflow-wrap:anywhere}.spotlightPublicPrinciple{padding:24px;border:1px solid #ddd6ca;border-radius:20px;background:#fff}.spotlightPublicPrinciple h2{font-size:1.45rem;margin:18px 0 10px}.spotlightPublicPath{display:flex;flex-wrap:wrap;gap:8px;margin-top:18px}.spotlightPublicPath span{padding:7px 9px;border:1px solid #ddd6ca;border-radius:999px;font-size:.75rem;font-weight:750}.spotlightPublicGrid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:18px}.spotlightPublicCard{display:flex;min-width:0;min-height:100%;flex-direction:column;justify-content:space-between;gap:24px;padding:22px;border:1px solid #ddd6ca;border-radius:18px;background:#fff}.spotlightPublicCard h3{margin:12px 0 5px;font-size:1.4rem;overflow-wrap:anywhere}.spotlightPublicCard h4{margin:0 0 12px;font-size:1rem}.spotlightPublicInitial{display:grid;width:58px;height:58px;margin:18px 0 14px;place-items:center;border:1px solid #d5c9b8;border-radius:50%;background:#fbf7ee;font-size:1.35rem;font-weight:850}.spotlightPublicContext{padding-top:10px;border-top:1px solid #eee8dd;font-size:.9rem;overflow-wrap:anywhere}.spotlightPublicCardActions{display:grid;gap:12px}.spotlightPublicCardActions .actions{margin:0}.spotlightAwardInfoGrid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:18px}.spotlightHistoryMonth{margin-top:32px}.spotlightHistoryMonth>h3{margin-bottom:14px}.spotlightPublicCard :focus-visible,.spotlightPublicPrinciple :focus-visible{outline:3px solid rgba(198,137,42,.38);outline-offset:3px}
      @media(max-width:1024px){.spotlightPublicHeroGrid{grid-template-columns:1fr;gap:24px}.spotlightPublicGrid{grid-template-columns:repeat(2,minmax(0,1fr))}.spotlightAwardInfoGrid{grid-template-columns:1fr}}
      @media(max-width:640px){.spotlightPublicHero{padding:38px 0 28px}.spotlightPublicHero h1{font-size:clamp(2.35rem,12vw,3.6rem)}.spotlightPublicGrid{grid-template-columns:1fr}.spotlightPublicCard{padding:18px}.spotlightPublicCardActions .actions{display:grid}.spotlightPublicCardActions .linkArrow{min-height:44px;display:flex;align-items:center}}

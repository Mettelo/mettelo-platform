...
const checks=[
  ...
  ['app/admin/project-operations/applications/page.tsx',['Admin / Projects / Requests','focusProjectId','query.eq(\'project_id\',focusProjectId)','AdminApplicationQueue']],
  ['components/AdminApplicationQueue.tsx',['Current review work','All statuses','Filter project requests by status','Rows per page','Previous','Next','No project requests match these filters','applicationTable','applicationMobileList']],

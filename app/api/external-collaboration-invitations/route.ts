...
export async function POST(request:Request){
 try{
  ...
  if(!live.accepting||!live.project||!live.run)return NextResponse.json({error:'This collaboration opportunity is no longer accepting people.'},{status:409});

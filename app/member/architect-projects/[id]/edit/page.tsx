...
export default async function EditArchitectProjectPage({params}:Context){
 ...
 return <section className="section softSection memberWorkspace"><div className="shell"><div className="sectionHead"><div><div className="eyebrow">Project Architect · Edit canonical draft</div><h1>Update the project without breaking its history.</h1></div><p>Changes write back to the same project definition. Reviewed resource evidence, stable child IDs and downstream Public → Member → Lab relationships are protected.</p></div><ArchitectProjectEditForm projectId={id} providers={providers||[]} capabilityCatalogue={capabilities||[]}/></div></section>;
}

...
const cases:[string,boolean][]=[
 ...
 ['Expected submissions are period-relative',hardening.includes('activated_at, pm.started_at')&&hardening.includes("target_period + interval '7 days'")&&hardening.includes("ended_at, pm.completed_at, 'infinity'::timestamptz")],

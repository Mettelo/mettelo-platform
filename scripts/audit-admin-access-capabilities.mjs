...
const checks=[
 ...
 ['tests/admin-access-capabilities.spec.ts',['website.content.edit','website.content.publish','admin.access.granted','admin.capabilities.updated','admin.access.revoked','current_user_id','390,768,1440']],
 ['docs/ADMIN-ACCESS-PERMISSIONS.md',['legacy','fail closed','Full Admin','Custom Admin','last remaining','password','Rollback']]
];

...
export async function PlatformContactEmail(){const settings=await getPublicPlatformSettings();const email=settings.get('contact_email')||'';if(!email)return null;return <a href={`mailto:${email}`}>{email}</a>}

...
expect('supabase/migrations/20260911110000_submit_interest_participation_journey.sql',['participation_preference text','secondary_project_role_id uuid','flexible_preference text','commitment_response text','create or replace function public.submit_project_interest','pg_advisory_xact_lock','PARTICIPATION_NOT_SUPPORTED','PRIMARY_ROLE_REQUIRED','PRIMARY_ROLE_FULL',"status not in ('declined','withdrawn')",'security definer','grant execute on function public.submit_project_interest']);

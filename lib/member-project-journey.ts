...
export function resolveMemberProjectState(input:ResolveMemberProjectStateInput):MemberProjectState{
  ...
  if(project.status==='completed'||!projectAcceptsApplications(project,input.now))return 'closed';
